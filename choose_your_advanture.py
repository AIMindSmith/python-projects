...
answer = input("You are in a dark room. There is a door to your left and right. Which one do you take? (left/right) :\n ").lower()
if answer =="left":
...
answer = input("You see a river. Do you want to swim across or build a raft? (swim/raft) :\n ").lower()
if answer == "swim":
    ...
    print("You choose a path that doesn't exist. Game Over.")
answer = input("You enter a village. There is a merchant who offers you a sword. Do you want to buy it? (yes/no) :\n ").lower()
if answer == "yes":
